"""storytelling_smith.py - Phase 4 technical modification.
...
STORYTELLING_CHART_FILE_1: Final[Path] = (
    CHARTS_OUTPUT / "storytelling_category_sales_smith.png"
)
STORYTELLING_CHART_FILE_2: Final[Path] = (
    CHARTS_OUTPUT / "storytelling_monthly_sales_smith.png"
)
